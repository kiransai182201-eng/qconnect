...
- Name: dashboard.spec.js >> Owner Management Dashboard & Settings spec >> should navigate settings and switch theme preference
- Location: tests\dashboard.spec.js:22:3
